...
<section id="how-it-works" style="padding:6rem 1.5rem;">
  <div style="max-width:1200px;margin:0 auto;">
    <div style="text-align:center;margin-bottom:3.5rem;">
      ...
      <p style="font-size:1.0625rem;color:var(--ink-soft);max-width:520px;margin:0 auto;line-height:1.75;">Three easy steps — from your heart to a child's future.</p>
    </div>
    <div class="three-col-grid" style="display:grid;grid-template-columns:repeat(3,1fr);gap:1.5rem;position:relative;">
      <div class="step-card" tabindex="0">
        ...
        <p style="color:var(--ink-soft);font-size:0.9375rem;line-height:1.7;">Select from our list of vetted, reputable charities and give with confidence. Every size gift makes a real difference.</p>
      </div>
      <div class="step-card" tabindex="0" style="border-color:var(--brand);box-shadow:0 4px 12px rgba(82,169,63,0.12),0 16px 40px rgba(0,0,0,0.08);">
        <div style="position:absolute;top:-1px;left:50%;transform:translateX(-50%);background:var(--brand);color:#fff;font-size:0.7rem;font-weight:700;padding:0.25rem 0.75rem;border-radius:0 0 8px 8px;letter-spacing:0.06em;">THE MAGIC</div>
        <div style="width:56px;height:56px;border-radius:16px;background:var(--brand-tint);display:flex;align-items:center;justify-content:center;margin-bottom:1.5rem;">
        ...
        <h3 style="font-size:1.375rem;margin-bottom:0.75rem;color:var(--ink);">We Match</h3>
        <p style="color:var(--ink-soft);font-size:0.9375rem;line-height:1.7;">Eligible donations receive a 9% match, subject to program limits.</p>
      ...
      <div class="step-card" tabindex="0">
        ...
        <h3 style="font-size:1.375rem;margin-bottom:0.75rem;color:var(--ink);">Impact Grows</h3>
        <p style="color:var(--ink-soft);font-size:0.9375rem;line-height:1.7;">Every dollar reaches children through carefully vetted programs in health and education worldwide.</p>
      </div>
    </div>
  </div>
</section>
...
<section style="padding:5.5rem 1.5rem;background:var(--brand-tint);border-top:1px solid rgba(82,169,63,0.18);border-bottom:1px solid rgba(82,169,63,0.18);position:relative;overflow:hidden;">
  ...
  <div style="max-width:760px;margin:0 auto;text-align:center;position:relative;z-index:1;">
    ...
    <h2 style="font-family:'Playfair Display',serif;font-size:clamp(1.6rem,3.5vw,2.4rem);font-weight:700;color:var(--ink);line-height:1.25;letter-spacing:-0.02em;margin-bottom:1.125rem;">
      We walk alongside established, reputable<br class="hidden-mobile"> organizations already serving communities.
    </h2>
    <p style="font-size:1.0625rem;color:var(--ink-soft);line-height:1.8;max-width:620px;margin:0 auto 3rem;">
      9 Fruit raises awareness and funds for charities with a proven history of impact and fiscal responsibility — amplifying the work already being done by those on the ground.
    </p>
